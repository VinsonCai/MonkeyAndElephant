 ...
 */
package com.seewo.animals;

import com.seewo.fruits.Fruit;
import com.seewo.invokers.EatInvoker;
import com.seewo.invokers.ElephantInvokerFactory;
...
public class Elephant extends Animal {
	...
	public Elephant(String pName) {
		super(pName);
	}

	@Override
	public void eatFruit(Fruit pFruit) {
		ElephantInvokerFactory factory = new ElephantInvokerFactory();
		EatInvoker invoker = factory.getEatFruitInvoker(this, pFruit);
		invoker.invokeEat();
	}
}
