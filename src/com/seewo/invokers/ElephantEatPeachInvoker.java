...
/**
 * @file ElephantEatPeachInvoker.java
 * @author VinsonCai
 * @brief
 * @date 2014-5-21 create
 */
public class ElephantEatPeachInvoker implements EatInvoker {

	private Elephant mElephant;
	private Peach mPeach;

	public ElephantEatPeachInvoker(Elephant pElephant, Peach pPeach) {
		mElephant = pElephant;
		mPeach = pPeach;
	}
	...
	public void invokeEat() {
		System.out.println(mElephant.getName() + " doesn't eat " + mPeach.getName());
	}
