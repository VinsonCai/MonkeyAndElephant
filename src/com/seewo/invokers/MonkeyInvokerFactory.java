...
/**
 * @file MonkeyInvokerFactory.java
 * @author VinsonCai
 * @brief
 * @date 2014-5-21 create
 */
public class MonkeyInvokerFactory extends InvokerFactory {

	@Override
	public EatInvoker getEatFruitInvoker(Animal pAnimal, Fruit pFruit) {
		if (pFruit instanceof Peach) {
			return new MonkeyEatPeachInvoker((Monkey) pAnimal, (Peach) pFruit);
		}
		else {
			return new MonkeyEatBananaInvoker((Monkey) pAnimal, (Banana) pFruit);
		}
	}
