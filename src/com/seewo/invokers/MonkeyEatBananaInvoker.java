...
/**
 * @file MonkeyEatBananaInvoker.java
 * @author VinsonCai
 * @brief
 * @date 2014-5-21 create
 */
public class MonkeyEatBananaInvoker implements EatInvoker {

	private Monkey mMonkey;
	private Banana mBanana;

	public MonkeyEatBananaInvoker(Monkey pMonkey, Banana pBanana) {
		mMonkey = pMonkey;
		mBanana = pBanana;
	}
	...
	public void invokeEat() {
		if (mBanana.isBad()) {
			System.out.println(mMonkey.getName() + " is eating " + mBanana.getName() + ", " + mMonkey.getName() + " is spitting:(");
		} else {
			System.out.println(mMonkey.getName() + " is eating " + mBanana.getName() + ", " + mMonkey.getName() + " is jumping ^_^");
		}
	}
