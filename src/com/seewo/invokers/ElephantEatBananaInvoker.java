...
/**
 * @file ElephantEatBananaInvoker.java
 * @author VinsonCai
 * @brief
 * @date 2014-5-21 create
 */
public class ElephantEatBananaInvoker implements EatInvoker {

	private Elephant mElephant;
	private Banana mBanana;

	public ElephantEatBananaInvoker(Elephant pElephant, Banana pBanana) {
		mElephant = pElephant;
		mBanana = pBanana;
	}

	@Override
	public void invokeEat() {
		if (mBanana.isBad()) {
			System.out.println(mElephant.getName() + " is eating " + mBanana.getName() + ", " + mElephant.getName() + " is spitting. :(");
		}
		else {
			System.out.println(mElephant.getName() + " is eating " + mBanana.getName() + ", " + mElephant.getName() + " is  raising nose:)");
		}
	}
