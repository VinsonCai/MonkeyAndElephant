 ...
 */
package com.seewo.invokers;

import com.seewo.animals.Animal;
import com.seewo.animals.Elephant;
import com.seewo.fruits.Banana;
import com.seewo.fruits.Fruit;
import com.seewo.fruits.Peach;

/**
 * @file ElephantInvokerFactory.java
 * @author VinsonCai
 * @brief
 * @date 2014-5-21 create
 */
public class ElephantInvokerFactory extends InvokerFactory {

	@Override
	public EatInvoker getEatFruitInvoker(Animal pAnimal, Fruit pFruit) {
		if (pFruit instanceof Peach) {
			return new ElephantEatPeachInvoker((Elephant) pAnimal, (Peach) pFruit);
		}
		else {
			return new ElephantEatBananaInvoker((Elephant) pAnimal, (Banana) pFruit);
		}
	}
