...
/**
 * @file MonkeyEatPeachInvoker.java
 * @author VinsonCai
 * @brief
 * @date 2014-5-21 create
 */
public class MonkeyEatPeachInvoker implements EatInvoker {

	private Monkey mMonkey;
	private Peach mPeach;;

	public MonkeyEatPeachInvoker(Monkey pMonkey, Peach pPeach) {
		mMonkey = pMonkey;
		mPeach = pPeach;
	}
	...
	public void invokeEat() {
		if (mPeach.isBad()) {
			System.out.println(mMonkey.getName() + " is eating " + mPeach.getName() + ", " + mMonkey.getName() + " is crying :(");
		}
		else {
			System.out.println(mMonkey.getName() + " is eating " + mPeach.getName() + ", " + mMonkey.getName() + " is laughing :)");
		}
	}
