...
import com.seewo.animals.Elephant;
import com.seewo.animals.Monkey;
import com.seewo.fruits.Banana;
import com.seewo.fruits.Fruit.State;
import com.seewo.fruits.Peach;

/**
 * @file Main.java
 * @author VinsonCai
 * @brief
 * @date 2014-5-21 create
 */
public class Main {
	...
	public static void main(String[] args) {
		...
		Monkey monkeyA = new Monkey("MonkeyA");

		Elephant elephantA = new Elephant("ElephantA");

		Peach goodPeach = new Peach("Good Peach", State.Good);
		Peach badPeach = new Peach("Bad Peach", State.BAD);

		Banana goodBanana = new Banana("Good Banana", State.Good);
		Banana badBanana = new Banana("Bad Banana", State.BAD);

		monkeyA.eatFruit(goodPeach);
		monkeyA.eatFruit(badPeach);
		monkeyA.eatFruit(goodBanana);
		monkeyA.eatFruit(badBanana);

		elephantA.eatFruit(goodPeach);
		elephantA.eatFruit(badPeach);
		elephantA.eatFruit(goodBanana);
		elephantA.eatFruit(badBanana);
	}
